...
import com.sap.engine.interfaces.messaging.api.exception.MessagingException;
   ...
   implements XIRecordFactory
 {
   ...
   public Message createMessageRecord(String fromParty, String toParty, String fromService, String toService, String action, String actionNS)
     throws ResourceException
   {
   ...
   public Message createMessageRecord(Party fromParty, Party toParty, Service fromService, Service toService, Action action)
     throws ResourceException
   {
   ...
   public Message createMessageRecord(String fromParty, String toParty, String fromService, String toService, String action, String actionNS, String messageId)
     throws ResourceException
   {
   ...
   public Message createMessageRecord(Party fromParty, Party toParty, Service fromService, Service toService, Action action, String messageId)
     throws ResourceException
   {
